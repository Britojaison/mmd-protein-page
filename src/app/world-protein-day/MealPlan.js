    ...
    <div className="space-y-6 max-w-7xl mx-auto animate-fadeIn">
      ...
      <div className="bg-gradient-to-br from-[#1e3a5f] via-[#2d4a6f] to-[#1e3a5f] text-white rounded-2xl p-6 md:p-8 shadow-xl animate-slideDown">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-white/10 backdrop-blur rounded-xl p-2 md:p-4 text-center border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105 animate-slideUp h-24 w-full md:h-auto flex flex-col justify-center" style={{ animationDelay: '0.1s' }}>
            <p className="text-blue-200 text-xs font-semibold uppercase mb-1">Daily Target</p>
            <p className="text-2xl md:text-3xl font-bold">{proteinRequired}g</p>
            <p className="text-blue-100 text-xs mt-1">Your goal</p>
          </div>
          <div className="bg-white/10 backdrop-blur rounded-xl p-2 md:p-4 text-center border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105 animate-slideUp h-24 w-full md:h-auto flex flex-col justify-center" style={{ animationDelay: '0.2s' }}>
            <p className="text-blue-200 text-xs font-semibold uppercase mb-1">Average Per Day</p>
            <p className="text-2xl md:text-3xl font-bold">{averageDailyProtein}g</p>
            {meetsTarget ? (
          ...
          <div className="bg-white/10 backdrop-blur rounded-xl p-2 md:p-4 text-center border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105 animate-slideUp h-24 w-full md:h-auto flex flex-col justify-center" style={{ animationDelay: '0.3s' }}>
            <p className="text-blue-200 text-xs font-semibold uppercase mb-1">Weekly Total</p>
            <p className="text-2xl md:text-3xl font-bold">{weeklyTotalProtein}g</p>
            <p className="text-blue-100 text-xs mt-1">If you follow plan</p>
          </div>
          <div className="bg-white/10 backdrop-blur rounded-xl p-2 md:p-4 text-center border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105 animate-slideUp h-24 w-full md:h-auto flex flex-col justify-center" style={{ animationDelay: '0.4s' }}>
            <p className="text-blue-200 text-xs font-semibold uppercase mb-1">Plan Quality</p>
            <div className="flex items-center justify-center gap-2">
              {meetsTarget ? (
                <>
                  <svg className="w-5 h-5 md:w-6 md:h-6 text-green-300 animate-bounce" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-lg md:text-xl font-bold">Optimal</span>
                </>
              ) : (
                <>
                  <svg className="w-5 h-5 md:w-6 md:h-6 text-blue-300" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
                  </svg>
                  <span className="text-lg md:text-xl font-bold">Good</span>
                </>
              )}
            </div>
          </div>
